...
export default function PropertyFeature({data, isChecked, toggleSelection}) {
  // console.log(data)
  return (
    <div className='max-w-600px p-8px-20px-8px-56px border-neutral-300 radius-100 position-relative cursor-pointer mr-btm-8px mr-t-16px' onClick={()=>toggleSelection(data['title']) }>                    
