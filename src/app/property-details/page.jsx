...
export async function generateMetadata({ params }) {
    return {
        title: "Details of Proprty",
        description: "See details of property"
    }
  }
...
const PropertyDetails = () => {
    ...
    const details = {
        ...
        //                     .slice(0, 4)
        //                     .map(async (img, idx)=><Image fill src={await import(`@/../public${img['imageUrl']}`)}/>)
        // const secondSegmentImageData = details['images'].slice(4)
        // console.log(images)
